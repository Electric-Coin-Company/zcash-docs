...
`Download Tarball for Debian Stretch v4.5.0 <https://z.cash/downloads/zcash-4.5.0-linux64-debian-stretch.tar.gz>`_
...
.. code-block:: bash
   ...
   sha256sum zcash-4.5.0-linux64-debian-stretch.tar.gz

Result: ``405ebe0379219109e4b22069bf96348852b032a52345fa93acfe415ffa15a969``
...
.. code-block:: bash
    ...
    tar -xvf zcash-4.5.0-linux64.tar.gz

    mv -t /usr/local/bin/ zcash-4.5.0/bin/*
