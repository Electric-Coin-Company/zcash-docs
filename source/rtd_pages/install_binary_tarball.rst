...
`Download Tarball for Debian Stretch v4.5.1 <https://z.cash/downloads/zcash-4.5.1-linux64-debian-stretch.tar.gz>`_
...
.. code-block:: bash
   ...
   sha256sum zcash-4.5.1-linux64-debian-stretch.tar.gz

Result: ``0484fa245b0e6d35beda30cc1fbe63a58eb41baccd68ccf90c587b371c4d5068``
...
.. code-block:: bash
    ...
    tar -xvf zcash-4.5.1-linux64.tar.gz

    mv -t /usr/local/bin/ zcash-4.5.1/bin/*
